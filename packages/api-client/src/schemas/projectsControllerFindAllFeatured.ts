...
export type ProjectsControllerFindAllFeatured = typeof ProjectsControllerFindAllFeatured[keyof typeof ProjectsControllerFindAllFeatured];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProjectsControllerFindAllFeatured = {
  true: 'true',
  false: 'false',
  NUMBER_1: '1',
  NUMBER_0: '0',
