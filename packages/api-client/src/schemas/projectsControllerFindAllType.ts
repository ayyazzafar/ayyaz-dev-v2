...
export type ProjectsControllerFindAllType = typeof ProjectsControllerFindAllType[keyof typeof ProjectsControllerFindAllType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProjectsControllerFindAllType = {
  PRODUCT: 'PRODUCT',
  CLIENT: 'CLIENT',
