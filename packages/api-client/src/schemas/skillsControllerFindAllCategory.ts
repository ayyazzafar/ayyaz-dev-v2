...
export type SkillsControllerFindAllCategory = typeof SkillsControllerFindAllCategory[keyof typeof SkillsControllerFindAllCategory];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SkillsControllerFindAllCategory = {
  FRONTEND: 'FRONTEND',
  BACKEND: 'BACKEND',
  DATABASE: 'DATABASE',
  DEVOPS: 'DEVOPS',
